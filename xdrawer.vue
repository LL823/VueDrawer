...
<script>
    export default {
        ...
        methods: {
            _size(){
                console.log(this.$refs.drawer.offsetHeight ,this.$refs.title.offsetHeight)
                this.$refs.content.style.height = this.$refs.drawer.offsetHeight - this.$refs.title.offsetHeight - 40 + 'px';
            }
        }
    }
</script>
